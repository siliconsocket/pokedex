...
const SvgPokeBallLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="PokeBallLogo_svg__Pok\xE9ball"
    x={0}
    y={0}
    style={{
    ...
    {...props}
  >
    <style>{".PokeBallLogo_svg__st0{fill:#fff}"}</style>
    <g id="PokeBallLogo_svg__Pok\xE9ball_1_">
      <g id="PokeBallLogo_svg__Colours">
        <path
          id="PokeBallLogo_svg__Down"
          ...
          className="PokeBallLogo_svg__st0"
        />
        <path
          id="PokeBallLogo_svg__Shadow_Down"
        ...
        />
        <path
          id="PokeBallLogo_svg__Shadow_Up"
...
const Memo = memo(SvgPokeBallLogo);
export default Memo;
